...
public class Cas20ProxyReceivingTicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    public Cas20ProxyReceivingTicketValidationFilter(String strExcludeFilter) {
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        validator.setProxyRetriever(
                new Cas20ProxyRetriever(casServerUrlPrefix, getPropertyFromInitParams(filterConfig, "encoding", null)));
