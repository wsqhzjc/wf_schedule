...
public class ConsistencyHash {
	 ...
	 * @return
	 */
	public String getAssignedRealNode(Object factor, String nodeId) {
		if (nodes.size() <= 1) {
			return nodeId;
		}
	...
	public static void main(String[] args) {
		...
		hash.refresh(new ArrayList<>(Arrays.asList("task1","task2", "task3")));
		
		for (int i = 1; i < 11; i++) {
			System.out.println(hash.getAssignedRealNode(i,"nodeId"));
		}
	}
